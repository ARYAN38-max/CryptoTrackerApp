...
public class CurrencyRVAdaptor extends RecyclerView.Adapter<CurrencyRVAdaptor.ViewHolder>
{
    private ArrayList<CurrencyRVModal> currencyRVModalArrayList;
    private Context context;
    private static DecimalFormat df2 = new DecimalFormat("#.##");

    public CurrencyRVAdaptor(ArrayList<CurrencyRVModal> currencyRVModalArrayList, Context context) {
    ...
    @NonNull
    @Override
    public CurrencyRVAdaptor.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.currency_rv_item, parent, false);
        return new CurrencyRVAdaptor.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CurrencyRVAdaptor.ViewHolder holder, int position)
    {
